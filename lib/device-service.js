...
class DeviceService{
    ...
    _init(){
        ...
        this.adapter.getStates('*.alive', (err, states) => {
            ...
            this.adapter.log.info('DeviceService initialized with ' + this.objectList.length + ' devices');
        });
    ...
    calcDeviceAlive(id, val){
        if(val !== null){
            this.objectList[id] = val;
        }else{
            delete this.objectList[id];
        }
        this.deviceAlive = false;
        Object.values(this.objectList).forEach(value=>{
            if(value === true){
    ...
    createDevice(id, data){
        ...
        this.adapter.setObjectNotExists('iogo.0.' + id + '.battery.level', {
            ...
            if (!err && obj) {
                ...
                this.adapter.setState('iogo.0.' + id + + '.battery.level', data.batteryLevel);
            }
        });
        ...
        this.adapter.setObjectNotExists('iogo.0.' + id + '.battery.charging', {
            ...
            if (!err && obj) {
                ...
                this.adapter.setState('iogo.0.' + id + + '.battery.charging', data.batteryCharging);
            }
        });
        ...
        this.adapter.setObjectNotExists('iogo.0.' + id + '.name', {
            ...
            if (!err && obj) {
                ...
                this.adapter.setState('iogo.0.' + id + + '.name', data.name);
            }
        });
        ...
        this.adapter.setObjectNotExists('iogo.0.' + id + '.token', {
            ...
            if (!err && obj) {
                ...
                this.adapter.setState('iogo.0.' + id + + '.token', data.token);
            }
        });
        ...
        this.adapter.setObjectNotExists('iogo.0.' + id + '.alive', {
            ...
            if (!err && obj) {
                ...
                this.adapter.setState('iogo.0.' + id + + '.alive', data.alive);
            }
        });
    }
